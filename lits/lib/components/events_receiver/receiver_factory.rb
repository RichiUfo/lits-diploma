  ...
  module EventsReceiver
    class ReceiverFactory
      def self.source_receiver(source_type_name)
        ...
        receiver_class_name = name.sub(
          'ReceiverFactory',
          source_type_name.capitalize.to_s + 'Receiver'
        )
      ...
      def self.load_events_of_source_type(source_type_name)
        ...
        sources  = Source.where(source_type_id: SourceType::KEYS[source_type_name.downcase.to_sym])
                         .all
