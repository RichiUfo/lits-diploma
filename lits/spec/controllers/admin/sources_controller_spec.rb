...
RSpec.describe Admin::SourcesController, type: :controller do
  ...
  # Admin::SourcesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_source" do
        source = Source.create! valid_attributes
        put :update, params: {id: source.to_param, admin_source: new_attributes}, session: valid_session
        source.reload
      ...
      it "assigns the requested admin_source as @admin_source" do
        source = Source.create! valid_attributes
        put :update, params: {id: source.to_param, admin_source: valid_attributes}, session: valid_session
        expect(assigns(:admin_source)).to eq(source)
      end
    ...
    context "with invalid params" do
      it "assigns the admin_source as @admin_source" do
        source = Source.create! valid_attributes
        put :update, params: {id: source.to_param, admin_source: invalid_attributes}, session: valid_session
        expect(assigns(:admin_source)).to eq(source)
      end
